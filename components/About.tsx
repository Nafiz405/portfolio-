    ...
    <div className="container mx-auto px-6 max-w-5xl">
      <div className="space-y-24">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20">
          ...
          {/* Creative Section */}
          <div className="group space-y-4 p-8 bg-neutral-900/30 rounded-3xl border border-white/5 hover:border-red-500/20 transition-all duration-500">
        ...
        <div className="relative p-12 md:p-20 bg-neutral-900 rounded-[40px] border border-white/5 overflow-hidden text-center">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="pt-4">
              <p className="text-2xl font-bold italic text-red-500">Let’s create something extraordinary together.</p>
            </div>
          </div>
        </div>
      </div>
